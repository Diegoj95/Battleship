...
public class Main {
      ...
      while (tablero.ganar() == 0) {
        ...
        for (int i = 1; i < n + 1; i++) {
          for (int j = 1; j < n + 1; j++) {
            ...
            // Paridad de 5
            if (destructor == false && crucero == false && submarino == false && buque == false
                && portaAviones == true) {
              if (i + j == 6 || i + j == 11) {
                mapaDensidadTotal[i][j] = 0;
              }
        ...
        if (disparado != '0' && disparado != 'X') {
          ...
          if (vidaPortaAviones == 0 && portaAviones == true) {
            portaAviones = false;
            barcoDestruido = true;
          }
          if (vidaBuque == 0 && buque == true) {
            buque = false;
            barcoDestruido = true;
          }
          if (vidaSubmarino == 0 && submarino == true) {
            submarino = false;
            barcoDestruido = true;
          }
          if (vidaCrucero == 0 && crucero == true) {
            crucero = false;
            barcoDestruido = true;
          }
          if (vidaDestructor == 0 && destructor == true) {
            destructor = false;
            barcoDestruido = true;
          }
  ...
  // Actualiza la matriz donde se ha disparado (miss con X y hit con la letra del
  // barco)
  ...
  // Obtener matriz de funcion de densidad probabilistica para cuando se esta
  // buscando un hit en el tablero (HUNT MODE)
  ...
  // Obtener matriz de funcion de densidad probabilistica para cuando se esta
  // derribando un barco (TARGET MODE)
  ...
  // Funcion de densidad probabilistica para un tipo de barco en todo el tablero
  // (TARGET MODE)
    ...
    for (int fila = 1; fila < matriz[0].length - 1; fila++) {
      for (int columna = 1; columna < matriz.length - 1; columna++) {
        if (matriz[fila][columna] == '0') {
          ...
          // Direccion Norte
          if (fila - 1 > 0 && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco))
            celdasLibresVertical++;
          if (fila - 2 > 0 && (matriz[fila - 2][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
              && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco) && barco > 2)
            celdasLibresVertical++;
          if (fila - 3 > 0 && (matriz[fila - 3][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
              && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
              && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco) && barco > 3)
            celdasLibresVertical++;
          if (fila - 4 > 0 && (matriz[fila - 4][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
              && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
              && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
              && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco) && barco > 4)
            celdasLibresVertical++;

          // Direccion Sur
          if (fila + 1 < n + 1 && (matriz[fila + 1][columna] == '0' || matriz[fila + 1][columna] == letraBarco))
            celdasLibresVertical++;
          if (fila + 2 < n + 1 && (matriz[fila + 2][columna] == '0' || matriz[fila + 1][columna] == letraBarco)
              && (matriz[fila + 1][columna] == '0' || matriz[fila + 1][columna] == letraBarco) && barco > 2)
            celdasLibresVertical++;
          if (fila + 3 < n + 1 && (matriz[fila + 3][columna] == '0' || matriz[fila + 1][columna] == letraBarco)
              && (matriz[fila + 1][columna] == '0' || matriz[fila + 1][columna] == letraBarco)
              && (matriz[fila + 1][columna] == '0' || matriz[fila + 1][columna] == letraBarco) && barco > 3)
            celdasLibresVertical++;
          if (fila + 4 < n + 1 && (matriz[fila + 4][columna] == '0' || matriz[fila + 1][columna] == letraBarco)
              && (matriz[fila + 1][columna] == '0' || matriz[fila + 1][columna] == letraBarco)
              && (matriz[fila + 1][columna] == '0' || matriz[fila + 1][columna] == letraBarco)
              && (matriz[fila + 1][columna] == '0' || matriz[fila + 1][columna] == letraBarco) && barco > 4)
            celdasLibresVertical++;
          if (celdasLibresVertical < barco)
            celdasLibresVertical = barco - 1;

          // Direccion Oeste
          if (columna - 1 > 0 && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco))
            celdasLibresHorizontal++;
          if (columna - 2 > 0 && (matriz[fila][columna - 2] == '0' || matriz[fila][columna - 1] == letraBarco)
              && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco) && barco > 2)
            celdasLibresHorizontal++;
          if (columna - 3 > 0 && (matriz[fila][columna - 3] == '0' || matriz[fila][columna - 1] == letraBarco)
              && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco)
              && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco) && barco > 3)
            celdasLibresHorizontal++;
          if (columna - 4 > 0 && (matriz[fila][columna - 4] == '0' || matriz[fila][columna - 1] == letraBarco)
              && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco)
              && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco)
              && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco) && barco > 4)
            celdasLibresHorizontal++;

          // Direccion Este
          if (columna + 1 < n + 1 && (matriz[fila][columna + 1] == '0' || matriz[fila][columna + 1] == letraBarco))
            celdasLibresHorizontal++;
          if (columna + 2 < n + 1 && (matriz[fila][columna + 2] == '0' || matriz[fila][columna + 1] == letraBarco)
              && (matriz[fila][columna + 1] == '0' || matriz[fila][columna + 1] == letraBarco) && barco > 2)
            celdasLibresHorizontal++;
          if (columna + 3 < n + 1 && (matriz[fila][columna + 3] == '0' || matriz[fila][columna + 1] == letraBarco)
              && (matriz[fila][columna + 1] == '0' || matriz[fila][columna + 1] == letraBarco)
              && (matriz[fila][columna + 1] == '0' || matriz[fila][columna + 1] == letraBarco) && barco > 3)
            celdasLibresHorizontal++;
          if (columna + 4 < n + 1 && (matriz[fila][columna + 4] == '0' || matriz[fila][columna + 1] == letraBarco)
              && (matriz[fila][columna + 1] == '0' || matriz[fila][columna + 1] == letraBarco)
              && (matriz[fila][columna + 1] == '0' || matriz[fila][columna + 1] == letraBarco)
              && (matriz[fila][columna + 1] == '0' || matriz[fila][columna + 1] == letraBarco) && barco > 4)
            celdasLibresHorizontal++;
          if (celdasLibresHorizontal < barco)
            celdasLibresHorizontal = barco - 1;
  ...
  // Funcion de densidad probabilistica de un tipo de barco para la periferia de
  // un hit (HUNT MODE)
  public static int[][] obtenerMapaDensidadObjetivo(char[][] matriz, int n, int largoBarco, int fila, int columna,
      char letraBarco) {
    ...
    // Direccion Norte
    if (fila - 1 > 0 && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco)) {
      densidad = largoBarco - 1;
      mapaDensidad[fila - 1][columna] = densidad;
    }
    if (fila - 2 > 0 && (matriz[fila - 2][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
        && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco) && largoBarco > 2) {
      densidad = largoBarco - 2;
      mapaDensidad[fila - 2][columna] = densidad;
    }
    if (fila - 3 > 0 && (matriz[fila - 3][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
        && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
        && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco) && largoBarco > 3) {
      densidad = largoBarco - 3;
      mapaDensidad[fila - 3][columna] = densidad;
    }
    if (fila - 4 > 0 && (matriz[fila - 4][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
        && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
        && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco)
        && (matriz[fila - 1][columna] == '0' || matriz[fila - 1][columna] == letraBarco) && largoBarco > 4) {
      densidad = largoBarco - 4;
      mapaDensidad[fila - 4][columna] = densidad;
    }
    ...
    if (columna - 1 > 0 && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco)) {
      densidad = largoBarco - 1;
      mapaDensidad[fila][columna - 1] = densidad;
    }
    if (columna - 2 > 0 && (matriz[fila][columna - 2] == '0' || matriz[fila][columna - 1] == letraBarco)
        && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco) && largoBarco > 2) {
      densidad = largoBarco - 2;
      mapaDensidad[fila][columna - 2] = densidad;
    }
    if (columna - 3 > 0 && (matriz[fila][columna - 3] == '0' || matriz[fila][columna - 1] == letraBarco)
        && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco)
        && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco) && largoBarco > 3) {
      densidad = largoBarco - 3;
      mapaDensidad[fila][columna - 3] = densidad;
    }
    if (columna - 4 > 0 && (matriz[fila][columna - 4] == '0' || matriz[fila][columna - 1] == letraBarco)
        && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco)
        && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco)
        && (matriz[fila][columna - 1] == '0' || matriz[fila][columna - 1] == letraBarco) && largoBarco > 4) {
      densidad = largoBarco - 4;
      mapaDensidad[fila][columna - 4] = densidad;
    }
